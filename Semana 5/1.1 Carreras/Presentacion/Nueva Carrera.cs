...
using _1._1_Carreras.Servicios;
...
namespace _1._1_Carreras
{
    ...
    {
        private ICarrerasService oService;
        Carrera c;
        ...
        {
            DataTable tabla = HelperDAO.GetInstance().Read("pa_ver_asignaturas");
        ...
        private void FrmNueva_Carrera_Load(object sender, EventArgs e)
        {
            CargarAsignaturas();
            c=new Carrera();
            oService=new ServiceFactory().CrearCarrerasService();
